...
imp_cond <- impliedConditionalIndependencies(dag)
...
formula <- bf(price ~ closure, family = Gamma())
...
# Extract effect of screwtop
screwtop_effect <- fixed_effects["closurescrewtop", "Estimate"]

# Calculate mean price for cork
mean_cork <- 1 / intercept

# Calculate mean price for screwtop
mean_screwtop <- 1 / (intercept + screwtop_effect)
...
# Extract Intercept
intercept <- fixed_effects_d["Intercept", "Estimate"]

# Extract effect of screwtop
screwtop_effect <- fixed_effects_d["ClosureScrewcap", "Estimate"]
